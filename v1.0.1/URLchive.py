...
class HomePage(QWidget):
    def __init__(self, go_to_page_callback):
        ...
        layout.setAlignment(
            Qt.AlignCenter
        )  # Aligns everything in the center vertically
        ...
        button_layout.setAlignment(
            Qt.AlignCenter
        )  # Aligns the button in the center horizontally
    ...
    def button_centered(self):
        ...
        button.clicked.connect(
            self.go_to_page_callback
        )  # Connect the button's click event here
        return button
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("URLchive v1.1")
        self.setGeometry(100, 100, 600, 400)

        # Set the application icon for the taskbar
        self.setWindowIcon(
            QIcon(r"..\Images\URL.ico")
        ...
        self.home_action = QAction(
            QIcon(r"..\Images\home_icon.png"), "Home", self
